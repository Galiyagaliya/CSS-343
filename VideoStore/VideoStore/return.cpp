...
// reads the line, get id and check for valid customer id
...
// if retrieve is succefull, proccess proccessReturn()
...
// check whether cusomer can return movie
// Check if customer actualy borrowed the movie.add error massage
